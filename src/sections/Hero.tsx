      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <div className={styles.socials}>
            <a href="https://github.com/VinnyPham" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
            ...
            <a href="https://www.linkedin.com/in/vinny-pham/" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
